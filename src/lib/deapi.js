...
export async function generateImage(prompt, initImgBuffer, mode, modelOverride) {
    ...
    if (mode === 'bikini') {
        ...
        negativePrompt += " artificial, 3d render, cartoon, digital art, airbrushed skin, plastic texture, smoothed face, fake lighting, changed background, modified face, (extra limbs:1.5), changed pose, modified pose, swapped pose, (original clothes visible:1.6), (underlying clothes:1.6), changed style, illustration, painting.";
    } else if (mode === 'nude') {
