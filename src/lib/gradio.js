...
export async function generateImage(prompt, initImgBuffer, mode) {
    ...
    if (mode === 'bikini') {
        ...
        negativePrompt += " clothes, dress, fabric, garments, bra, underwear, bikini, swimsuit, lingerie, strappy clothing, changed pose, modified body, fake anatomy, modified face, swapped face, face distortion, plastic texture, airbrushed, cgi, flat look, oversaturated, modified background, (three legs, extra limbs, fused limbs:1.6).";
