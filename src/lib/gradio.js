...
export async function generateImage(prompt, initImgBuffer, mode) {
    ...
    if (mode === 'bikini') {
        ...
        negativePrompt += " artificial, 3d render, cartoon, digital art, airbrushed skin, plastic texture, smoothed face, fake lighting, changed background, modified face, changed pose, modified pose, swapped pose, (unremoved clothes:1.6), (visible original clothes:1.6), changed style, illustration, painting, (missing belly button:2.5), (missing limbs:2.5), (deleted body parts:2.5).";
    } else if (mode === 'nude') {
